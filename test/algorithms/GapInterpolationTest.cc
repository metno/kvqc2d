...
TEST_F(GapInterpolationTest, MinMaxTooFar)
{
    ...
    data.add("2012-07-10 08:00:00",       3.2,       3.2, "0111000000100010", "")
        ...
        //.add("2012-07-10 14:00:00",  -32767.0,       3.7, "0000001100000000", "QC2d-2-I")
        ...
        //.add("2012-07-10 20:00:00",  -32767.0,       3.2, "0000001100000000", "QC2d-2-I")
        .add("2012-07-10 21:00:00",       3.3,       3.3, "0111000000100010", "")
        .add("2012-07-10 22:00:00",  -32767.0,  -32767.0, "0000003000000000", "")
        //.add("2012-07-10 22:00:00",  -32767.0,       3.3, "0000001100000000", "QC2d-2-I")
    ...
    data.setStation(99752).setType(330)
        ...
        .add("2012-07-10 14:00:00",  -32767.0,  -32767.0, "0000003000000000", "")
        //.add("2012-07-10 14:00:00",  -32767.0,       3.6, "0000001100000000", "QC2d-2-I")
        ...
        .add("2012-07-10 20:00:00",  -32767.0,  -32767.0, "0000003000000000", "")
        //.add("2012-07-10 20:00:00",  -32767.0,       3.1, "0000001100000000", "QC2d-2-I")
        .add("2012-07-10 21:00:00",       3.1,       3.1, "0110000000000000", "")
        .add("2012-07-10 22:00:00",  -32767.0,  -32767.0, "0000003000000000", "")
        //.add("2012-07-10 22:00:00",  -32767.0,       2.9, "0000001100000000", "QC2d-2-I")
    ...
    data.setStation(99752).setType(330)
        ...
        .add("2012-07-10 14:00:00",  -32767.0,  -32767.0, "0000003000000000", "")
        //.add("2012-07-10 14:00:00",  -32767.0,       4.2, "0000001100000000", "QC2d-2-I")
        ...
        .add("2012-07-10 20:00:00",  -32767.0,  -32767.0, "0000003000000000", "")
        //.add("2012-07-10 20:00:00",  -32767.0,       3.4, "0000001100000000", "QC2d-2-I")
        .add("2012-07-10 21:00:00",       3.5,       3.5, "0110000000000000", "")
        .add("2012-07-10 22:00:00",  -32767.0,  -32767.0, "0000003000000000", "")
        //.add("2012-07-10 22:00:00",  -32767.0,       3.4, "0000001100000000", "QC2d-2-I")
    ...
    data.add("2012-07-10 08:00:00",       3.7,       3.7, "0111000000100010", "")
        ...
        //.add("2012-07-10 16:00:00",  -32767.0,       5.0, "0000001100000000", "QC2d-2-I")
    ...
    const double expectedI[N] = { 3.7, 3.4, 3.8, 3.2, 3.3, 3.0, 3.1, 3.4, 3.4, 5.0 };
    const char* expectedTS[N] = { "2012-07-10 14:00:00", "2012-07-10 14:00:00", "2012-07-10 14:00:00",
...
TEST_F(GapInterpolationTest, UUBecomes0WithoutNieghbors)
{
    ...
    ASSERT_CONFIGURE(algo, params);
    ASSERT_RUN(algo, bc, 3);
    EXPECT_NEAR(7.8, bc->update(0).corrected(), 0.01);
    EXPECT_NEAR(7.8, bc->update(1).corrected(), 0.5);
    EXPECT_NEAR(7.8, bc->update(2).corrected(), 0.5);
    // EXPECT_NEAR(90,  bc->update(3).corrected(),  5);
