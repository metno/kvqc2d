...
TEST_F(GapInterpolationTest, GapInMultiplePar)
{
    ...
    data.setStation(28380).setType(330)
        .add("2012-03-25 18:00:00",    1030.4,    1030.4, "0100000000000010", "")
        .add("2012-03-25 19:00:00",    1031.1,    1031.1, "0100000000000010", "")
        .add("2012-03-25 20:00:00",    1031.7,    1031.7, "0100000000000010", "")
        .add("2012-03-25 21:00:00",    1031.9,    1031.9, "0100000000000010", "")
        .add("2012-03-25 22:00:00",    1032.0,    1032.0, "0100000000000010", "")
        .add("2012-03-25 23:00:00",    1032.5,    1032.5, "0100000000000010", "")
        .add("2012-03-26 00:00:00",    1032.6,    1032.6, "0100000000000010", "")
        .add("2012-03-26 01:00:00",    1032.5,    1032.5, "0100000000000010", "");
    data.setStation(30650).setType(311)
        .add("2012-03-25 18:00:00",    1030.8,    1030.8, "0100000000000010", "")
        .add("2012-03-25 19:00:00",    1031.4,    1031.4, "0100000000000010", "")
        .add("2012-03-25 20:00:00",    1032.2,    1032.2, "0100000000000010", "")
        .add("2012-03-25 21:00:00",    1032.5,    1032.5, "0100000000000010", "")
        .add("2012-03-25 22:00:00",    1032.6,    1032.6, "0100000000000010", "")
        .add("2012-03-25 23:00:00",    1033.0,    1033.0, "0100000000000010", "")
        .add("2012-03-26 00:00:00",    1033.1,    1033.1, "0100000000000010", "")
        .add("2012-03-26 01:00:00",    1033.2,    1033.2, "0100000000000010", "");
    data.setParam(211);
    ...
    data.setStation(17850).setType(330)
        .add("2012-03-25 18:00:00",       9.2,       9.2, "0111000000100010", "")
        .add("2012-03-25 19:00:00",       9.1,       9.1, "0111000000100010", "")
        .add("2012-03-25 20:00:00",       6.8,       6.8, "0111000000100010", "")
        .add("2012-03-25 21:00:00",       5.0,       5.0, "0111000000100010", "")
        .add("2012-03-25 22:00:00",       4.0,       4.0, "0111000000100010", "")
        .add("2012-03-25 23:00:00",       3.1,       3.1, "0111000000100010", "")
        .add("2012-03-26 00:00:00",       2.3,       2.3, "0111000000100010", "")
        .add("2012-03-26 01:00:00",       1.2,       1.2, "0111000000100010", "");
    data.setStation(18230).setType(330)
        .add("2012-03-25 18:00:00",      11.8,      11.8, "0111000000100010", "")
        .add("2012-03-25 19:00:00",      10.4,      10.4, "0111000000100010", "")
        .add("2012-03-25 20:00:00",       9.0,       9.0, "0111000000100010", "")
        .add("2012-03-25 21:00:00",       7.5,       7.5, "0111000000100010", "")
        .add("2012-03-25 22:00:00",       6.1,       6.1, "0111000000100010", "")
        .add("2012-03-25 23:00:00",       5.4,       5.4, "0111000000100010", "")
        .add("2012-03-26 00:00:00",       4.4,       4.4, "0111000000100010", "")
        .add("2012-03-26 01:00:00",       3.7,       3.7, "0111000000100010", "");
    data.setStation(18700).setType(330)
    ...
    data.setStation(28380).setType(330)
        .add("2012-03-25 18:00:00",      11.1,      11.1, "0111000000100010", "")
        .add("2012-03-25 19:00:00",       6.8,       6.8, "0111000000100010", "")
        .add("2012-03-25 20:00:00",       6.4,       6.4, "0111000000100010", "")
        .add("2012-03-25 21:00:00",       5.9,       5.9, "0111000000100010", "")
        .add("2012-03-25 22:00:00",       5.0,       5.0, "0111000000100010", "")
        .add("2012-03-25 23:00:00",       5.4,       5.4, "0111000000100010", "")
        .add("2012-03-26 00:00:00",       4.1,       4.1, "0111000000100010", "")
        .add("2012-03-26 01:00:00",       4.0,       4.0, "0111000000100010", "");
    data.setStation(30650).setType(311)
        .add("2012-03-25 18:00:00",      11.9,      11.9, "0111000000100010", "")
        .add("2012-03-25 19:00:00",       7.6,       7.6, "0111000000100010", "")
        .add("2012-03-25 20:00:00",       5.0,       5.0, "0111000000100010", "")
        .add("2012-03-25 21:00:00",       3.7,       3.7, "0111000000100010", "")
        .add("2012-03-25 22:00:00",       3.3,       3.3, "0111000000100010", "")
        .add("2012-03-25 23:00:00",       3.1,       3.1, "0111000000100010", "")
        .add("2012-03-26 00:00:00",       2.2,       2.2, "0111000000100010", "")
