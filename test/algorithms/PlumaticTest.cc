...
TEST_F(PlumaticTest, NonOperationalZeroes)
{
    ...
    data.add("2011-10-02 16:00:00", 0.0, "0101000000000000", "")
        .add("2011-10-02 17:00:00", 0.0, "0101000000000000", "")
    ...
    EXPECT_EQ(0, logs->find("ignoring non-operational .* 2011-10-01 17:01:00 and 2011-10-01 18:00:00"));
    EXPECT_EQ(1, logs->find("ignoring non-operational .* 2011-10-01 22:01:00 and 2011-10-01 23:00:00"));
    EXPECT_EQ(2, logs->find("ignoring non-operational .* 2011-10-02 01:01:00 and 2011-10-02 03:00:00"));
    EXPECT_EQ(3, logs->find("ignoring non-operational .* 2011-10-02 05:01:00 and 2011-10-02 06:00:00"));
    EXPECT_EQ(4, logs->find("ignoring non-operational .* 2011-10-02 09:01:00 and 2011-10-02 10:00:00"));
    EXPECT_EQ(5, logs->find("ignoring non-operational .* 2011-10-02 17:01:00 and 2011-10-02 18:00:00"));
}
