...
TEST_F(GapInterpolationTest, DoNotSetTo80_1)
{
    std::ostringstream sql;
    INSERT_STATION(sql, 31520, "GROSET",                      59.836,  8.315,  949);
    INSERT_STATION(sql, 31620, "MØSSTRAND II",               59.840,  8.178,  977);
    INSERT_STATION(sql, 31660, "MOGEN",                       60.018,  7.913,  954);
    INSERT_STATION(sql, 33300, "HONNEGRASNUTEN",              59.767,  7.817, 1340);
    INSERT_STATION(sql, 33890, "VÅGSLI",                     59.766,  7.365,  821);
    INSERT_STATION(sql, 77050, "HALTENBANKEN",                65.100,  7.600,    0);
    ASSERT_NO_THROW_X(db->exec(sql.str()));

    DataList data(15262, 211, 501);
    data.setStation(31520).setType(505)
        .add("2019-01-17 17:00:00",      -9.0,      -9.0, "0111100000100010", "")
        .add("2019-01-17 18:00:00",     -10.0,     -10.0, "0111100000100010", "")
        .add("2019-01-17 19:00:00",      -9.6,      -9.6, "0111100000100010", "")
        .add("2019-01-17 20:00:00",  -32767.0,      -9.6, "0000601000000000", "QC1-4-211")
        .add("2019-01-17 20:00:00",      -9.6,      -9.6, "0111100000100010", "")
        .add("2019-01-17 21:00:00",      -9.6,      -9.6, "0111100000100010", "");
    data.setStation(31620).setType(330)
        .add("2019-01-17 17:00:00",     -10.1,     -10.1, "0111100000100010", "")
        .add("2019-01-17 18:00:00",      -9.6,      -9.6, "0111100000100010", "")
        .add("2019-01-17 19:00:00",      -9.7,      -9.7, "0111100000100010", "")
        .add("2019-01-17 20:00:00",      -9.9,      -9.9, "0111100000100010", "")
        .add("2019-01-17 21:00:00",     -10.5,     -10.5, "0111100000100010", "");
    data.setStation(31660).setType(505)
        .add("2019-01-17 17:00:00",      -9.7,      -9.7, "0111100000100010", "")
        .add("2019-01-17 18:00:00",     -10.8,     -10.8, "0111100000100010", "")
        .add("2019-01-17 19:00:00",     -11.3,     -11.3, "0111100000100010", "")
        .add("2019-01-17 20:00:00",     -12.3,     -12.3, "0111100000100010", "")
        .add("2019-01-17 21:00:00",     -11.3,     -11.3, "0111100000100010", "");
    data.setStation(33300).setType(501)
        .add("2019-01-17 17:00:00",      -9.9,      -9.9, "0111100000100010", "")
        .add("2019-01-17 18:00:00",     -10.9,     -10.9, "0111100000100010", "")
        .add("2019-01-17 19:00:00",  -32767.0,     -11.5, "0000601000000000", "QC1-4-211")
        .add("2019-01-17 20:00:00",     -11.9,     -11.9, "0110100000100010", "")
        .add("2019-01-17 21:00:00",     -11.8,     -11.8, "0111100000100010", "");
    data.setStation(33890).setType(330)
        .add("2019-01-17 17:00:00",      -7.0,      -7.0, "0111100000100010", "")
        .add("2019-01-17 18:00:00",      -6.8,      -6.8, "0111100000100010", "")
        .add("2019-01-17 19:00:00",      -7.4,      -7.4, "0111100000100010", "")
        .add("2019-01-17 20:00:00",      -7.8,      -7.8, "0111100000100010", "")
        .add("2019-01-17 21:00:00",     -10.6,     -10.6, "0111100000100010", "");
    data.setParam(213);
    data.setStation(31520).setType(505)
        .add("2019-01-17 17:00:00",      -9.8,      -9.8, "0111100000000010", "")
        .add("2019-01-17 18:00:00",     -11.9,     -11.9, "0111100000000010", "")
        .add("2019-01-17 19:00:00",     -10.3,     -10.3, "0111100000000010", "")
        .add("2019-01-17 20:00:00",     -10.0,     -10.0, "0111100000000010", "")
        .add("2019-01-17 21:00:00",     -10.1,     -10.1, "0111100000000010", "");
    data.setStation(31620).setType(330)
        .add("2019-01-17 17:00:00",     -10.4,     -10.4, "0111100000000010", "")
        .add("2019-01-17 18:00:00",     -10.9,     -10.9, "0111100000000010", "")
        .add("2019-01-17 19:00:00",      -9.7,      -9.7, "0111100000000010", "")
        .add("2019-01-17 20:00:00",     -10.5,     -10.5, "0111100000000010", "")
        .add("2019-01-17 21:00:00",     -10.6,     -10.6, "0111100000000010", "");
    data.setStation(31660).setType(505)
        .add("2019-01-17 17:00:00",     -10.8,     -10.8, "0111100000000010", "")
        .add("2019-01-17 18:00:00",     -11.0,     -11.0, "0111100000000010", "")
        .add("2019-01-17 19:00:00",     -12.3,     -12.3, "0111100000000010", "")
        .add("2019-01-17 20:00:00",     -12.6,     -12.6, "0111100000000010", "")
        .add("2019-01-17 21:00:00",     -11.9,     -11.9, "0111100000000010", "");
    data.setStation(31680).setType(505)
        .add("2019-01-17 17:00:00",     -10.8,     -10.8, "0111100000000010", "")
        .add("2019-01-17 18:00:00",     -10.9,     -10.9, "0111100000000010", "")
        .add("2019-01-17 19:00:00",     -11.3,     -11.3, "0111100000000010", "")
        .add("2019-01-17 20:00:00",  -32767.0,  -32767.0, "0000103000000000", "")
        .add("2019-01-17 21:00:00",  -32767.0,  -32767.0, "0000103000000000", "");
    data.setStation(33300).setType(501)
        .add("2019-01-17 17:00:00",     -11.3,     -11.3, "0111100000000010", "")
        .add("2019-01-17 18:00:00",     -11.6,     -11.6, "0111100000000010", "")
        .add("2019-01-17 19:00:00",  -32767.0,  -32767.0, "0000103000000000", "")
        .add("2019-01-17 20:00:00",     -12.1,     -12.1, "0110100000000010", "")
        .add("2019-01-17 21:00:00",     -12.2,     -12.2, "0111100000000010", "");
    data.setStation(33890).setType(330)
        .add("2019-01-17 17:00:00",      -8.7,      -8.7, "0111100000000010", "")
        .add("2019-01-17 18:00:00",      -9.0,      -9.0, "0111100000000010", "")
        .add("2019-01-17 19:00:00",      -7.6,      -7.6, "0111100000000010", "")
        .add("2019-01-17 20:00:00",      -7.9,      -7.9, "0111100000000010", "")
        .add("2019-01-17 21:00:00",     -10.6,     -10.6, "0111100000000010", "");
    data.setParam(215);
    data.setStation(31520).setType(505)
        .add("2019-01-17 17:00:00",      -8.4,      -8.4, "0111100000000010", "")
        .add("2019-01-17 18:00:00",      -8.8,      -8.8, "0111100000000010", "")
        .add("2019-01-17 19:00:00",      -8.8,      -8.8, "0111100000000010", "")
        .add("2019-01-17 20:00:00",      -9.1,      -9.1, "0111100000000010", "")
        .add("2019-01-17 21:00:00",      -9.0,      -9.0, "0111100000000010", "");
    data.setStation(31620).setType(330)
        .add("2019-01-17 17:00:00",      -9.6,      -9.6, "0111100000000010", "")
        .add("2019-01-17 18:00:00",      -9.5,      -9.5, "0111100000000010", "")
        .add("2019-01-17 19:00:00",      -9.0,      -9.0, "0111100000000010", "")
        .add("2019-01-17 20:00:00",      -9.7,      -9.7, "0111100000000010", "")
        .add("2019-01-17 21:00:00",      -9.8,      -9.8, "0111100000000010", "");
    data.setStation(31660).setType(505)
        .add("2019-01-17 17:00:00",      -8.8,      -8.8, "0111100000000010", "")
        .add("2019-01-17 18:00:00",     -10.5,     -10.5, "0111100000000010", "")
        .add("2019-01-17 19:00:00",     -10.2,     -10.2, "0111100000000010", "")
        .add("2019-01-17 20:00:00",     -11.1,     -11.1, "0111100000000010", "")
        .add("2019-01-17 21:00:00",     -10.9,     -10.9, "0111100000000010", "");
    data.setStation(33300).setType(501)
        .add("2019-01-17 17:00:00",      -9.7,      -9.7, "0111100000000010", "")
        .add("2019-01-17 18:00:00",     -10.0,     -10.0, "0111100000000010", "")
        .add("2019-01-17 19:00:00",  -32767.0,  -32767.0, "0000103000000000", "")
        .add("2019-01-17 20:00:00",     -11.1,     -11.1, "0110100000000010", "")
        .add("2019-01-17 21:00:00",     -11.6,     -11.6, "0111100000000010", "");
    data.setStation(33890).setType(330)
        .add("2019-01-17 17:00:00",      -7.0,      -7.0, "0111100000000010", "")
        .add("2019-01-17 18:00:00",      -6.5,      -6.5, "0111100000000010", "")
        .add("2019-01-17 19:00:00",      -6.6,      -6.6, "0111100000000010", "")
        .add("2019-01-17 20:00:00",      -7.3,      -7.3, "0111100000000010", "")
        .add("2019-01-17 21:00:00",      -7.7,      -7.7, "0111100000000010", "");
    ASSERT_NO_THROW(data.insert(db));

    std::stringstream config;
    config << "Start_YYYY = 2019\n"
           << "Start_MM   =   01\n"
           << "Start_DD   =   17\n"
           << "Start_hh   =   17\n"
           << "End_YYYY   = 2019\n"
